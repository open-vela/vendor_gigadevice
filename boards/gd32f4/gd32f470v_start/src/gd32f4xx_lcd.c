/****************************************************************************
 * vendor/gigadevice/boards/gd32f4/gd32f470v_start/src/gd32f4xx_lcd.c
 *
...
#ifdef CONFIG_GD32F470V_START_ILI9341_LCDDEVICE
#  define ILI9341_LCD_DEVICE CONFIG_GD32F470V_START_ILI9341_LCDDEVICE
#else
#  define ILI9341_LCD_DEVICE 0
#endif

#ifdef CONFIG_GD32F470V_START_ILI9341_FBIFACE
...
#if defined(CONFIG_GD32F470V_START_ILI9341_FBIFACE_LANDSCAPE)
...
#elif defined(CONFIG_GD32F470V_START_ILI9341_FBIFACE_PORTRAIT)
#  define GD32_ILI9341_MADCTL_PARAM  ILI9341_MADCTL_PORTRAIT_PARAM1
#elif defined(CONFIG_GD32F470V_START_ILI9341_FBIFACE_RLANDSCAPE)
#  define GD32_ILI9341_MADCTL_PARAM  ILI9341_MADCTL_RLANDSCAPE_PARAM1
# warning "ILI9341 doesn't support full landscape with RGB interface"
#elif defined(CONFIG_GD32F470V_START_ILI9341_FBIFACE_RPORTRAIT)
...
#endif /* CONFIG_GD32F470V_START_ILI9341_FBIFACE */

/****************************************************************************
 * Private Data
 ****************************************************************************/

#ifdef CONFIG_GD32F470V_START_ILI9341_LCDIFACE
...
#endif /* CONFIG_GD32F470V_START_ILI9341_LCDIFACE */
