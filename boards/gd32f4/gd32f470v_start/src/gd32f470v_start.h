/****************************************************************************
 * vendor/gigadevice/boards/gd32f4/gd32f470v_start/src/gd32f470v_start.h
 *
...
#ifndef __BOARDS_ARM_GD32F4_GD32F470V_START_SRC_GD32F470V_START_H
#define __BOARDS_ARM_GD32F4_GD32F470V_START_SRC_GD32F470V_START_H
...
/* GD32F470V_START GPIO Pin Definitions ******************************************/

/* LED
 *
 * The GD32F470V_START board has user LEDs, LED1, LED2 and LED3, that can be
 * controlled by software.
 * The following definitions assume the default Solder Bridges are installed.
 */

#define GPIO_LED1       (GPIO_CFG_PORT_E | GPIO_CFG_OUTPUT_RESET | GPIO_PIN2_OUTPUT)
#define GPIO_LED2       (GPIO_CFG_PORT_E | GPIO_CFG_OUTPUT_RESET | GPIO_PIN3_OUTPUT)
#define GPIO_LED3       (GPIO_CFG_PORT_F | GPIO_CFG_OUTPUT_RESET | GPIO_PIN10_OUTPUT)
...
/* BUTTONS
 *
 * The GD32F470V Start board has User, Tamper, and Wakeup key, the are
...
#define GPIO_SPI5_CS      (GPIO_CFG_PORT_I | GPIO_PIN8_OUTPUT)
 ...
 */
   ...
   !defined(CONFIG_GD32F470V_START_GD25_BLOCKMOUNT)
#  undef HAVE_GD25
#endif
...
#ifndef CONFIG_GD32F470V_START_AT24_TEST
#  undef HAVE_AT24
#endif
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the GD32F470V
 *   Eval board.
 *
 ****************************************************************************/
 ...
 *
 * Description:
 *   Called from gd32_bringup to initialize external SDRAM access.
 *
 ****************************************************************************/
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_GD32F4_GD32F470V_START_SRC_GD32F470V_START_H */
