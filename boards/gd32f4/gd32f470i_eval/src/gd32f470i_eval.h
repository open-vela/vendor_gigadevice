/****************************************************************************
 * vendor/gigadevice/boards/gd32f4/gd32f470i_eval/src/gd32f470i_eval.h
 *
...
#ifndef __BOARDS_ARM_GD32F4_GD32F470IK_EVAL_SRC_GD32F470I_EVAL_H
#define __BOARDS_ARM_GD32F4_GD32F470IK_EVAL_SRC_GD32F470I_EVAL_H
...
/* GD32F470IK GPIO Pin Definitions ******************************************/

/* LED
 *
 * The GD32F470IK-EVAL board has three LEDs, LED1, LED2 and LED3, that can be
...
/* BUTTONS
 *
 * The GD32F470I Eval board has User, Tamper, and Wakeup key, the are
 ...
 */
   ...
   !defined(CONFIG_GD32F470I_EVAL_GD25_BLOCKMOUNT)
#  undef HAVE_GD25
#endif
...
#ifndef CONFIG_GD32F470I_EVAL_AT24_TEST
#  undef HAVE_AT24
#endif
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the GD32F470I
 *   Eval board.
 *
 ****************************************************************************/
