/****************************************************************************
 * vendor/gigadevice/boards/gd32f4/gd32f470i_eval/src/gd32f4xx_gd25.c
 *
...
#if defined(CONFIG_GD32F470I_EVAL_GD25_FTL)
...
#elif defined(CONFIG_GD32F470I_EVAL_GD25_NXFFS)
...
#elif defined(CONFIG_GD32F470I_EVAL_GD25_LITTLEFS)
